...
namespace RealEstate_Dapper_UI.Areas.EstateAgent.ViewComponents.EstateAgentNavViewComponents
{
    public class _NavbarLast3MessageComponentPartial : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7091/api/Message?id=" + id);
